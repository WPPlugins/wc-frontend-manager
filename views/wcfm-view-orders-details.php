...
<div class="collapse wcfm-collapse" id="wcfm_order_details">
  ...
  <div class="wcfm-page-headig">
	...
	<div class="wcfm-collapse-content">
		...
		<h2><?php _e( 'Order #', 'wc-frontend-manager' ); echo $order_id; ?></h2>
			...
			<div id="orders_details_items_expander" class="wcfm-content">
				<table cellpadding="0" cellspacing="0" class="woocommerce_order_items">
					<thead>
						<tr>
							...
							<th class="quantity sortable no_mob" data-sort="int"><?php _e( 'Qty', 'wc-frontend-manager' ); ?></th>
				...
				<div class="wc-order-data-row wc-order-totals-items wc-order-items-editable">
					...
					<table class="wc-order-totals">
						<?php if( $is_wcfm_order_details_coupon_line_item = apply_filters( 'wcfm_order_details_coupon_line_item', true ) ) { ?>
							<tr>
								<td class="label"><span class="img_tip" data-tip="<?php _e( 'This is the total discount. Discounts are defined per line item.', 'wc-frontend-manager' ) ; ?>"></span> <?php _e( 'Discount', 'wc-frontend-manager' ); ?>:</td>
								<td width="1%"></td>
								<td class="total">
						...
						<?php if( $is_wcfm_order_details_shipping_line_item = apply_filters( 'wcfm_order_details_shipping_line_item', true ) ) { ?>
							<tr>
								<td class="label"><span class="img_tip" data-tip="<?php _e( 'This is the shipping and handling total costs for the order.', 'wc-frontend-manager' ) ; ?>"></span> <?php _e( 'Shipping', 'wc-frontend-manager' ); ?>:</td>
								<td width="1%"></td>
								<td class="total"><?php
